  ...
  <div class="Actualizar">
    ...
    <form method="post" action="updateProducto.php">
      <div class="col-auto">
        ...
        <input type="text" class="form-control" id="nombreP" aria-describedby="origen" value="<?php echo $vec[1] ?>"
          name="nomP">
      </div>
      <div class="col-auto">
        <i class="bi bi-geo-alt-fill"></i>
        <label for="exampleInputEmail1" class="form-label">Precio</label>
        <input type="number" class="form-control" id="pre" aria-describedby="destino" value="<?php echo $vec[2] ?>"
          name="valP">
      </div>
      <div class="col-auto">
        <i class="bi bi-calendar"></i>
        <label for="exampleInputEmail1" class="form-label">Existencia</label>
        <input type="number" class="form-control" id="existe" aria-describedby="Salida" value="<?php echo $vec[3] ?>"
          name="exis">
      </div>
      <div class="col-auto">
        <i class="bi bi-calendar"></i>
        <label for="exampleInputEmail1" class="form-label">Imagen URL</label>
        <input type="text" class="form-control" id="imgs" aria-describedby="image" value="<?php echo $vec[4] ?>"
          name="urlI">
      </div><br>
